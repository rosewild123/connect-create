...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Senda — Match. Collab. Create." },
      { name: "twitter:description", content: "Senda is where adult creators discover and connect with each other for collabs, shoots, and promos." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/56afb8cb-9779-4d5d-9264-df151dd50877/id-preview-979a2b07--483fdf89-5e09-448e-98c1-d930215b9bd3.lovable.app-1781256194255.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/56afb8cb-9779-4d5d-9264-df151dd50877/id-preview-979a2b07--483fdf89-5e09-448e-98c1-d930215b9bd3.lovable.app-1781256194255.png" },
    ],
    links: [
